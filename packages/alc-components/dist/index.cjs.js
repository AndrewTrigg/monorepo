...
function PrimaryButton(_a) {
    ...
    return jsxRuntime.jsxs(MUIButton__default['default'], __assign({ className: classes.root, disabled: disabled, variant: "outlined" }, { children: [children, "Will this go to both repos hopefully"] }), void 0);
}
