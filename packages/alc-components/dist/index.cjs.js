...
function PrimaryButton(_a) {
    ...
    return jsxRuntime.jsxs(MUIButton__default['default'], __assign({ className: classes.root, disabled: disabled, variant: "outlined" }, { children: [children, "Matthew This actually works fantastic"] }), void 0);
}
